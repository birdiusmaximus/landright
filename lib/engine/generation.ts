...
// Option B was gpt-5.5 ($5/$30); gpt-5.4 ($2.50/$15) ~halves per-generation cost
// so the monthly limit can be higher for the same spend, with a small quality
// trade-off on the elevated option.
const MODEL_B = "gpt-5.4";
